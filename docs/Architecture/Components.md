...
| Repository                                                                    | Distribution                                                               | Comments |
|-------------------------------------------------------------------------------|----------------------------------------------------------------------------|----------|
| [Google BigQuery Adaptor](https://github.com/apache/datasketches-bigquery)    | [Downloads](https://datasketches.apache.org/docs/Community/Downloads.html) | Depends on C++ Core, [Integrations](https://github.com/apache/datasketches-bigquery/blob/main/README.md) |
